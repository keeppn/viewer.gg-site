...
function LoginScreen({ onAuthenticated }: { onAuthenticated: () => void }) {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (particlesRef.current) {
        const dots = particlesRef.current.querySelectorAll(".login-particle");
        dots.forEach((dot, i) => {
          gsap.to(dot, {
            y: `${-20 - (i % 3) * 10}px`,
  ...
  const particles = Array.from({ length: 30 }, (_, i) => ({
    ...
    top: `${(i * 53 + 7) % 100}%`,
    size: 2 + (i % 3),
    color: i % 3 === 0 ? B.orange : i % 3 === 1 ? B.blue : "rgba(255,255,255,0.15)",
  }));
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: "440px", padding: "0 24px" }}>
        ...
        >
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "4px" }}>
            {"BROKS".split("").map((l, i) => (
              <span key={`a${i}`} className="login-letter" style={{
                display: "inline-block", fontSize: "clamp(36px, 6vw, 52px)",
          ...
          <div style={{
            marginTop: "12px", fontSize: "11px", letterSpacing: "0.25em",
        ...
        <form
          ...
          style={{
            ...
            border: `1px solid ${error ? "#ef4444" : isExiting ? "#22c55e" : "rgba(255,255,255,0.06)"}`,
            borderRadius: "20px",
            padding: "36px 32px",
        ...
        >
          <div ref={fieldsRef} style={{ opacity: 0 }}>
            {/* Username */}
            <div style={{ marginBottom: "20px" }}>
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: "12px", color: B.white,
                  fontSize: "15px", fontFamily: "inherit",
                  outline: "none",
                  transition: "border-color 0.2s, box-shadow 0.2s",
                }}
                onFocus={(e) => {
                  e.target.style.borderColor = `${B.orange}60`;
                  e.target.style.boxShadow = `0 0 20px ${B.orange}10`;
                }}
                onBlur={(e) => {
            ...
            <button
              ...
              style={{
                ...
                fontFamily: "inherit", cursor: isExiting ? "wait" : "pointer",
                transition: "transform 0.2s, box-shadow 0.2s",
                boxShadow: `0 4px 20px ${B.orange}30`,
              }}
              onMouseEnter={(e) => {
                if (!isExiting) {
                  e.currentTarget.style.transform = "translateY(-1px)";
                  e.currentTarget.style.boxShadow = `0 6px 30px ${B.orange}40`;
                }
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow = `0 4px 20px ${B.orange}30`;
              }}
            >
...
export default function BroksVisionPage() {
  ...
  const circleLabelRefs = useRef<(HTMLDivElement | null)[]>([]);
    ...
    const ctx = gsap.context(() => {
      ...
      if (introRef.current && introWordsRef.current) {
        ...
        introTl
          ...
          .fromTo(words, { opacity: 0, y: 20 }, { opacity: 1, y: 0, stagger: 0.03, ease: "power2.out" }, "placeholder")
          .addLabel("reveal", "+=0.3")
          .to(placeholders, { autoAlpha: 0, stagger: 0.03, ease: "power2.inOut" }, "reveal")
          .fromTo(spans, { opacity: 0, scale: 0.9 }, { opacity: 1, scale: 1, stagger: 0.03, ease: "power2.out" }, "reveal");
      ...
      // ═══ 360° CIRCLE ═══
      // Properly sequenced: ring fills → 360° text → labels one by one → then exit
      if (circleRef.current && circleRingRef.current && circleTextRef.current) {
        ...
        // Phase 2 (20-45%): "360°" text appears
        circleTl.fromTo(
          circleTextRef.current,
          { opacity: 0, scale: 0.6 },
          { opacity: 1, scale: 1, ease: "back.out(1.7)", duration: 0.15 },
          0.2
        );

        // Phase 3 (40-70%): Labels appear one by one at their positions (no overlap)
        circleLabelRefs.current.forEach((labelEl, i) => {
          if (!labelEl) return;
          circleTl.fromTo(
            labelEl,
            { opacity: 0, scale: 0.5 },
        ...
        // Phase 4 (75-100%): Everything fades out and section exits
        circleTl.to(
          circleRef.current.querySelector(".circle-content"),
      ...
      if (footerRef.current) {
        gsap.fromTo(
          footerRef.current.querySelectorAll(".footer-card"),
  ...
  // ─── CIRCLE LABELS — positioned at cardinal points, no overlap ───
  const circleLabels = [
    { text: "Creative", angle: -90 },   // top
    { text: "PR", angle: 0 },           // right
    { text: "Digital", angle: 90 },      // bottom
    { text: "BTL", angle: 180 },         // left
  ];
  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        :root { --ease-out: cubic-bezier(0.22, 1.00, 0.36, 1.00); --ease-in-out: cubic-bezier(0.84, 0.00, 0.16, 1.00); }
      ...
      <section ref={heroRef} style={{ height: "300svh", position: "relative", width: "100%" }}>
        <div
          ref={heroBgRef}
          style={{ background: B.black, position: "absolute", inset: 0, willChange: "opacity", zIndex: 1 }}
        />

        <div style={{
          position: "sticky", top: 0, height: "100svh", minHeight: "100svh", overflow: "hidden",
          ...
          <div ref={heroScaleRef} style={{
            ...
            <div ref={heroTopRef} style={{ position: "relative", zIndex: 10, willChange: "transform, opacity" }}>
              ...
              <h1 style={{
                ...
                letterSpacing: "-0.04em", lineHeight: 0.85, margin: 0, color: B.white,
              }}>
                BROKS<br />
              ...
              <p style={{
                fontSize: "clamp(16px, 1.8vw, 22px)", color: "rgba(255,255,255,0.45)",
                maxWidth: "480px", margin: "32px auto 0", lineHeight: 1.5, fontWeight: 400,
              }}>
              ...
              <div style={{ marginTop: "48px", display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
                <a href="#services" className="bv-btn" style={{
                ...
                <a href="mailto:hello@broksvision.com" className="bv-btn" style={{
                  display: "inline-flex", alignItems: "center", gap: "10px",
                  padding: "16px 36px", borderRadius: "100px",
      ...
      {/* ═══ 360° CIRCLE — Fixed: proper sequencing, no overlap, scroll-synced ═══ */}
      <section
        ref={circleRef}
      ...
      >
        <div style={{
          ...
          <div style={{
            ...
            background: `radial-gradient(circle, ${B.orange}12, transparent 70%)`,
            filter: "blur(60px)", pointerEvents: "none",
          }} />

          {/* All circle content wrapper (for fade-out) */}
          <div className="circle-content" style={{
            ...
            >
              <circle cx="150" cy="150" r="140" fill="none" stroke="rgba(255,255,255,0.06)" strokeWidth="2" />
              <circle
                ref={circleRingRef}
                cx="150" cy="150" r="140"
            ...
            {/* Center text — appears FIRST after ring starts */}
            <div
              ref={circleTextRef}
              style={{ position: "absolute", textAlign: "center", zIndex: 3, opacity: 0 }}
            >
              <div style={{
                fontSize: "clamp(56px, 9vw, 100px)", fontWeight: 900,
                letterSpacing: "-0.04em", lineHeight: 0.9, color: B.white,
              }}>
                360°
              </div>
              <div style={{
                fontSize: "clamp(12px, 1.3vw, 16px)", fontWeight: 500,
                letterSpacing: "0.15em", textTransform: "uppercase",
            ...
            {/* Labels — positioned at cardinal points, appear AFTER text */}
            {circleLabels.map((label, i) => {
              // Calculate position: top, right, bottom, left of the circle
              const rad = (label.angle * Math.PI) / 180;
              // Use percentage-based positioning relative to the container
              const offsetPx = 58; // distance outside the ring in %
              const positions: Record<number, React.CSSProperties> = {
                [-90]: { top: `-${offsetPx}px`, left: "50%", transform: "translateX(-50%)" },     // top
                [0]: { right: `-${offsetPx + 20}px`, top: "50%", transform: "translateY(-50%)" },  // right
                [90]: { bottom: `-${offsetPx}px`, left: "50%", transform: "translateX(-50%)" },    // bottom
                [180]: { left: `-${offsetPx + 20}px`, top: "50%", transform: "translateY(-50%)" }, // left
              };

              return (
                <div
                  key={label.text}
                  ref={(el) => { circleLabelRefs.current[i] = el; }}
                  style={{
                    position: "absolute",
                    ...positions[label.angle],
                    padding: "10px 24px",
                    borderRadius: "100px",
                    background: "rgba(255,255,255,0.04)",
                    border: "1px solid rgba(255,255,255,0.08)",
                    ...
                    color: B.orange, whiteSpace: "nowrap",
                    opacity: 0, zIndex: 5,
                  }}
                >
                  {label.text}
      ...
      <div id="services">
        {chapters.map((ch, i) => (
          <section
            ...
            style={{ height: "200svh", position: "relative" }}
          >
            <div
              ...
              style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                background: ch.bg, willChange: "clip-path, transform",
                clipPath: "inset(8% round 40px)",
              }}
            >
              <div style={{
              ...
              <div
                ...
                style={{
                  ...
                  padding: "0 clamp(24px, 8vw, 128px)", maxWidth: "1000px", width: "100%",
                }}
              >
                <div
                  ...
                  style={{
                    ...
                    padding: "8px 20px", borderRadius: "100px",
                    background: `${ch.accent}15`, border: `1px solid ${ch.accent}25`,
                ...
                <div
                  ...
                  style={{
                    ...
                    color: ch.accent, marginBottom: "24px",
                  }}
                >
                  {ch.title.split(" ").map((word, wi) => (
                    <span key={wi} className="ch-word" style={{ opacity: 0, marginRight: "0.25em" }}>{word}</span>
                  ))}
                </div>
                ...
                <p
                  ...
                  style={{
                    ...
                    color: `${ch.accent}99`, maxWidth: "600px", fontWeight: 400, opacity: 0,
                  }}
                >{ch.desc}</p>
              </div>
              ...
              <div style={{
                ...
                color: `${ch.accent}06`, letterSpacing: "-0.05em",
      ...
      <section ref={ctaRef} style={{
        ...
        <div ref={ctaContentRef} style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: "900px" }}>
          ...
          <div style={{
            fontSize: "clamp(44px, 8vw, 100px)", fontWeight: 900,
            letterSpacing: "-0.04em", lineHeight: 0.9, marginBottom: "32px",
          }}>
            {"Ready to Build Something Great?".split(" ").map((word, i) => (
              <span key={i} className="cta-word" style={{ display: "inline-block", marginRight: "0.25em", opacity: 0 }}>{word}</span>
            ))}
          </div>

          <p className="cta-sub" style={{
            fontSize: "clamp(16px, 1.5vw, 20px)", color: "rgba(255,255,255,0.4)",
            maxWidth: "500px", margin: "0 auto 48px", lineHeight: 1.6, opacity: 0,
          }}>
            Whether you need a full rebrand or a targeted campaign, we&apos;re ready to make it happen.
          </p>

          <a href="mailto:hello@broksvision.com" className="bv-btn cta-btn" style={{
            display: "inline-flex", alignItems: "center", gap: "12px",
            padding: "20px 48px", borderRadius: "100px",
            background: `linear-gradient(135deg, ${B.orange}, ${B.orangeLight})`,
            color: B.black, fontWeight: 700, fontSize: "17px",
            textDecoration: "none", border: "none",
            boxShadow: `0 0 60px ${B.orange}30`, opacity: 0,
          }}>
            Get in Touch
      ...
      <footer ref={footerRef} className="bv-footer" style={{
        ...
        padding: "clamp(40px, 6vw, 80px)", overflow: "hidden",
      }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "12px" }}>
            <div className="footer-card" style={{
              background: B.orange, borderRadius: "clamp(24px, 4vw, 56px)",
              padding: "clamp(32px, 4vw, 56px)", aspectRatio: "1",
              display: "flex", flexDirection: "column", justifyContent: "space-between",
              border: `1.5px solid ${B.black}`, overflow: "hidden", position: "relative",
            }}>
              <div style={{
                fontSize: "clamp(32px, 5vw, 72px)", fontWeight: 900,
                letterSpacing: "-0.04em", lineHeight: 0.9, color: B.black,
              }}>
                BR<span style={{ opacity: 0.6 }}>O</span>KS<br />
                VISI<span style={{ opacity: 0.6 }}>O</span>N
              </div>
              <div style={{
                fontSize: "clamp(12px, 1.2vw, 16px)", fontWeight: 600,
                letterSpacing: "0.1em", textTransform: "uppercase", color: B.black, opacity: 0.6,
              }}>360° Marketing</div>
              <div style={{
            ...
            <div className="footer-card" style={{
              background: B.blue, borderRadius: "clamp(24px, 4vw, 56px)",
              ...
              <div>
                <div style={{
                  ...
                  letterSpacing: "-0.03em", lineHeight: 1, color: B.cream, marginBottom: "16px",
                }}>
                  Let&apos;s start<br />your project
                </div>
                <p style={{
                  fontSize: "clamp(13px, 1.2vw, 16px)", color: "rgba(253,249,240,0.6)",
              ...
              <a href="mailto:hello@broksvision.com" className="bv-btn" style={{
                ...
                border: `1px solid ${B.black}`, width: "fit-content", marginTop: "24px",
              }}>
                Contact Us
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "12px" }}>
            <div className="footer-card" style={{
              background: `${B.blue}15`, borderRadius: "clamp(24px, 4vw, 48px)",
              ...
              {["Creative", "PR", "Digital", "BTL", "Branding", "Strategy"].map((link) => (
                <span key={link} style={{
                  ...
                  letterSpacing: "-0.02em", color: B.black, opacity: 0.7,
            ...
            <div className="footer-card" style={{
              background: B.black, borderRadius: "clamp(24px, 4vw, 48px)",
              padding: "clamp(24px, 3vw, 40px)",
              display: "flex", flexDirection: "column", justifyContent: "center",
              alignItems: "center", textAlign: "center", border: `1.5px solid ${B.black}`,
            }}>
      ...
      <button
        ...
        style={{
          ...
          padding: exporting ? "16px 28px" : "16px 24px", borderRadius: "100px",
          border: `1px solid ${exportDone ? "#22c55e" : "rgba(255,255,255,0.12)"}`,
          background: exportDone ? "rgba(34,197,94,0.15)" : exporting ? "rgba(239,131,22,0.1)" : "rgba(10,10,15,0.85)",
          backdropFilter: "blur(16px)", color: exportDone ? "#22c55e" : B.white,
          fontSize: "13px", fontWeight: 600, fontFamily: "inherit",
          cursor: exporting ? "wait" : "pointer",
          transition: "all 0.4s cubic-bezier(0.22, 1, 0.36, 1)",
          boxShadow: exportDone ? "0 0 30px rgba(34,197,94,0.2)" : "0 4px 24px rgba(0,0,0,0.4)",
        }}
        onMouseEnter={(e) => {
